                    ...
                    <fieldset>
                        ...
                        <div class="join-box">
                            ...
                            <div class="basic">
                                ...
                                <input type="password" id="youPass" maxlength="20" name="youPass" placeholder="비밀번호를 적어주세요!" required>
                                <p class="comment" id="youPassComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" maxlength="20" name="youPassC" placeholder="똑같은 비밀번호를 적어주세요!" required>
                                <p class="comment" id="youPassCComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youName">이름</label>
                                <input type="text" id="youName" maxlength="5" name="youName" placeholder="이름을 적어주세요!" required>
                                <p class="comment" id="youNameComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youBirth">생년월일</label>
                                <input type="text" id="youBirth" maxlength="12" name="youBirth" placeholder="YYYY-MM-DD" required>
                                <p class="comment" id="youBirthComment"></p>
                            </div>
                            <div class="basic">
                                <label for="youPhone">휴대폰 번호</label>
                                <input type="text" id="youPhone" maxlength="15" name="youPhone" placeholder="000-0000-0000" required>
    ...
    <script>
        ...
        function joinChecks(){
            ...
            if(!getBirth.test($("#youBirth").val())){
                $("#youBirthComment").text("생년 월일이 정확하지 않습니다. 올바른 생년월일(YYYY-MM-DD)를 입력해주세요!");
                $("#youBirthComment").val("");
                return false;
            }
            ...
            //휴대폰 번호 유효성 검사
            //  let getPhone = RegExp(/^\d{3}-\d{3,4}-\d{4}$/);
            let getPhone = RegExp(/01[016789]-[^0][0-9]{2,3}-[0-9]{4}/);
