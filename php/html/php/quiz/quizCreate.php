        ...
        <section id="quiz-type" class="section center gray">
            <div class="container">
                ...
                <p class="section__desc">
                    ...
                    문제에 대한 저작권은 본인한테 있으며, 만약 다른 부분을 참고 하셨다면, 출처 부탁드립니다.
                </p> 
                            ...
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <select name="quizSubject" id="quizSubject">
                                        ...
                                        <option value="jqeury">제이쿼리</option>
                                ...
                                <div>
                                    ...
                                    <textarea name="quizAsk" id="quizAsk" name="" placeholder="문제를 작성해주세요!" required></textarea>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea name="quizSource" id="quizSource" placeholder="만약 다른 문제를 인용하셨다면 출처 표시 부탁드립니다."></textarea>
                                </div>
                                <div class="quiz__btn">
